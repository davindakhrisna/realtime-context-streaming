...
### Optimized Workflow for this Repo

Work on the project -> Development code that works but not perfect -> Commit to Repo

Pull from Repo -> Audit -> Same process

All task complete -> Audit -> Commit -> End
